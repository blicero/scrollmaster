...
# Time-stamp: <2024-09-15 20:26:36 krylon>
#
...
** Clock table
   ...
   #+CAPTION: Clock summary at [2024-09-15 So 20:26]
   | Headline                           | Time       |            |       |       |      |
   |------------------------------------+------------+------------+-------+-------+------|
   | *Total time*                       | *3d 11:33* |            |       |       |      |
   |------------------------------------+------------+------------+-------+-------+------|
   | *Scrollmaster*                     | *3d 11:33* |            |       |       |      |
   ...
   | \_    Analysis [0/0]               |            |            |  0:40 |       |      |
   | \_  /Components [12/12]/           |            | /2d 12:24/ |       |       |      |
   | \_    Main [0/0]                   |            |            |  0:59 |       |      |
   | \_    Common [1/1]                 |            |            |  3:46 |       |      |
   | \_      Paths                      |            |            |       |  3:46 |      |
   | \_    Build script                 |            |            |  1:15 |       |      |
   | \_    Model [0/0]                  |            |            |  1:04 |       |      |
   | \_    Logreader [1/2]              |            |            | 12:26 |       |      |
   | \_      Journald                   |            |            |       |  1:37 |      |
   | \_      Syslog                     |            |            |       |  8:25 |      |
   | \_    Database [0/0]               |            |            |  3:40 |       |      |
   | \_    Server [4/4]                 |            |            | 10:03 |       |      |
