...
# Time-stamp: <2024-09-09 22:14:25 krylon>
#
...
** Clock table
   ...
   #+CAPTION: Clock summary at [2024-09-09 Mo 22:14]
   | Headline                           | Time       |           |       |       |      |
   |------------------------------------+------------+-----------+-------+-------+------|
   | *Total time*                       | *2d 12:18* |           |       |       |      |
   |------------------------------------+------------+-----------+-------+-------+------|
   | *Scrollmaster*                     | *2d 12:18* |           |       |       |      |
   | \_  /Features [0/0]/               |            | /8:19/    |       |       |      |
   | \_    Search [0/0]                 |            |           |  8:19 |       |      |
   | \_  /Components [10/12]/           |            | /2d 3:59/ |       |       |      |
   | \_    Main [0/0]                   |            |           |  0:59 |       |      |
   | \_    Common [1/1]                 |            |           |  3:46 |       |      |
   | \_      Paths                      |            |           |       |  3:46 |      |
   | \_    Build script                 |            |           |  1:15 |       |      |
...
*** Search [0/0]
    ...
    somewhat. My current first attempt at build a search form is too ugly to bear. 
** Components [10/12]
   :PROPERTIES:
   :COOKIE_DATA: todo recursive
   :VISIBILITY: children
