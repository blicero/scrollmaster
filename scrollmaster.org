...
# Time-stamp: <2024-09-16 19:55:15 krylon>
#
...
** Clock table
   ...
   #+CAPTION: Clock summary at [2024-09-16 Mo 19:55]
   | Headline                           | Time       |            |       |       |      |
   |------------------------------------+------------+------------+-------+-------+------|
   | *Total time*                       | *3d 12:48* |            |       |       |      |
   |------------------------------------+------------+------------+-------+-------+------|
   | *Scrollmaster*                     | *3d 12:48* |            |       |       |      |
   ...
   | \_    Analysis [0/0]               |            |            |  0:40 |       |      |
   | \_  /Components [12/12]/           |            | /2d 13:39/ |       |       |      |
   | \_    Main [0/0]                   |            |            |  0:59 |       |      |
   | \_    Common [1/1]                 |            |            |  3:46 |       |      |
   | \_      Paths                      |            |            |       |  3:46 |      |
   | \_    Build script                 |            |            |  1:15 |       |      |
   | \_    Model [0/0]                  |            |            |  1:04 |       |      |
   | \_    Logreader [1/2]              |            |            | 13:41 |       |      |
   | \_      Journald                   |            |            |       |  1:37 |      |
   | \_      Syslog                     |            |            |       |  9:40 |      |
   | \_    Database [0/0]               |            |            |  3:40 |       |      |
   | \_    Server [4/4]                 |            |            | 10:03 |       |      |
